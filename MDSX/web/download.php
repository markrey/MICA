...
<body>
	...
	<div class="headercontainer"> 
		...
		<div class="headertitle">DOWNLOAD LIST</div>
	...
	<div id="inner_content" style="width: 80%; margin: 0 auto;">
	eMMC<br>
    <iframe src="frameEMMC.php" name="ue" height=20% width=70% frameborder=0 marginheight=0 marginwidth=0>この部分は iframe 対応のブラウザで見てください(1)。</iframe>
	<br>microSD<br>
    <iframe src="frameSdCard.php" name="naka" height=20% width=70% frameborder=0 marginheight=0 marginwidth=0>この部分は iframe 対応のブラウザで見てください(2)。</iframe>
	<br>USB<br>
    <iframe src="frameFlashUSB.php" name="sita" height=20% width=70% frameborder=0 marginheight=0 marginwidth=0>この部分は iframe 対応のブラウザで見てください(2)。</iframe>
